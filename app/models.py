from sqlalchemy import Boolean, Column, Integer, BigInteger, String, DateTime, ForeignKey, Table
...
class Account(Base):
    ...
    account_api_id = Column(BigInteger, default=None, nullable=False)
    ...
    account_phone = Column(String(25), default=None, nullable=False)
...
class Channel(Base):
    ...
    channel_size = Column(BigInteger, nullable=True)
...
class Message(Base):
    ...
    keyword_id = Column(BigInteger, ForeignKey('keyword.keyword_id'), nullable=False)
    ...
    message_channel_size = Column(BigInteger, default=None)
...
class Monitor(Base):
    ...
    monitor_id = Column(BigInteger, primary_key=True, index=True)
...
class Notification(Base):
    ...
    id = Column(BigInteger, primary_key=True, index=True)
    keyword_id = Column(BigInteger, ForeignKey('keyword.keyword_id'), nullable=False)
    message_id = Column(BigInteger, ForeignKey('message.message_id'), nullable=False)
    channel_id = Column(BigInteger, ForeignKey('channel.channel_id'), nullable=False)
    account_id = Column(BigInteger, ForeignKey('account.account_id'), nullable=False)  # The account ID (bot)
    chat_user_id = Column(BigInteger, ForeignKey('chat_user.chat_user_id'), nullable=False)
